// One database handle for the whole CRM.
// DATABASE_URL set  -> node-postgres Pool (Postgres, Supabase, Neon, anything Postgres-shaped).
// DATABASE_URL unset -> PGlite, an embedded Postgres persisted under ./.data/crm (or CRM_DATA_DIR).
...
export function dataDir() {
  return path.resolve(REPO_ROOT, process.env.CRM_DATA_DIR || './.data/crm');
}
